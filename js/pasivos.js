      ...
      function pasivos() {
        swal({
          title: "¡Estás aquí!",
          text: "Actualmente estás realizando pasivos",
      ...
      function capital() {
        if(conteo==9){
          window.open("juegoCuentasCapital.html", "_self");
        }else{
          swal({
          ...
          drop: function(event, ui) {
            ...
            if (cajaXId === boxId) {
              ...
              if(conteo===9){
                swal({
                  title: "¡FELICIDADES!",
                  text: "Completaste todas las cuentas en pasivos, puedes pasar a CAPITAL CONTABLE",
